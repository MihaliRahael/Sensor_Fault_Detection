...
class ModelEvaluation:
    ...
    def initiate_model_evaluation(self)->ModelEvaluationArtifact:
        try:
            ...
            # we need full sensor csv file. then why we are concatatnating train and test data
            # cant we take the whole csv itself?
            # cos we are passign both train and test through data validation stages for cleaning up unnecessary data
